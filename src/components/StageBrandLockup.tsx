  ...
  return (
    <div className="aiasap-brand-lockup absolute left-0 right-0 top-3 z-10 flex flex-col items-center pb-1 pt-1 sm:pt-2 md:top-[calc(var(--stage-top)+0.25rem)] md:pt-0">
      <div className="text-center px-4">
        ...
        <p data-stage-tagline="1" className="aiasap-tablet-idle-tagline -mt-1 whitespace-nowrap opacity-100 text-[calc(var(--stage-width)*0.025)] font-[540] tracking-[0.14976em] max-[599px]:scale-x-[0.9] md:mt-0 md:tracking-[0.12672em] xl:tracking-[0.14976em] uppercase drop-shadow-[0_1px_6px_rgba(25,15,5,0.4)]">
          <TaglineText />
        </p>
      </div>
      {children}
