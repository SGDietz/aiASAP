    ...
    >
      ...
      >
        <defs>
          ...
          <linearGradient id="six-loading-badge-shimmer" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0" stopColor="#ffe0a4" stopOpacity="0" />
            <stop offset="0.5" stopColor="#ffe0a4" stopOpacity="0.42" />
            <stop offset="1" stopColor="#ffe0a4" stopOpacity="0" />
          </linearGradient>
        </defs>
        ...
        />
        <rect
          data-six-loading-shimmer-band="1"
          x="-360"
          y="12.5"
          width="260"
          height="487"
          fill="url(#six-loading-badge-shimmer)"
          clipPath="url(#six-loading-rim-interior-80)"
        />
        <rect
