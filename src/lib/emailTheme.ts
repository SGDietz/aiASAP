...
/** 6's framed photo, as used in the locked design. */
export const SIX_PHOTO_URL =
  "https://wqszxsqzkaatghyrqviv.supabase.co/storage/v1/object/public/email-assets/startscreen_trim.png";
...
<style>
  ...
  .tag { font-family:${SANS}; font-size:14px; font-weight:800; letter-spacing:7px; text-transform:uppercase; color:${THEME.tagline}; margin:0 0 24px; text-align:center; }
