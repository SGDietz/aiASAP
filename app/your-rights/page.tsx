...
const paidWorkStatement =
  "Once you have paid for the client-specific work we deliver, you own 100% of it and everything you build from it. If it helps you create one billion-dollar company—or several—aiASAP waives any and all rights to your future success. We will never come after you for royalties, equity, profit share, or any other money based on that success.";
const brokenContractStatement =
  "If you break the contract before ownership transfers—such as by not paying in full—you do not own the rights to that work. Work from unpaid future phases is not included.";
    ...
    <main className="min-h-screen w-full bg-white px-4 py-6 text-black [color-scheme:light] dark:bg-black dark:text-white dark:[color-scheme:dark] sm:px-6 sm:py-10">
      <article className="mx-auto max-w-3xl">
        ...
        <div className="space-y-10 py-8 text-base leading-7 sm:text-[17px] sm:leading-8">
          ...
          <section>
            <h2 className="text-2xl font-bold leading-tight">If the Contract Is Broken</h2>
            <p className="mt-4">{brokenContractStatement}</p>
          </section>
