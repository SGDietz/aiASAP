...
function normalizePrompts(value: unknown): string[] {
  ...
  return [...unique, ...FALLBACK_PROMPTS]
    ...
    const messages = [
      {
        role: "system",
        content:
          "You are the quiet on-screen idea brain for aiASAP's voice assistant, 6. Return JSON only, shaped like {\"prompts\":[\"\",\"\",\"\",\"\"]}. Generate exactly four tappable conversation prompts for what the user is discussing right now. No numbering. No labels. No quotes. No punctuation at the end. Keep each prompt 2 to 4 words. Use title case, but keep small connector words lowercase, such as a, an, and, for, of, the, this, and to. All four prompts should be useful: tightly related to the topic, or a natural segue toward improving the user's life. Never use Change Subject. Prefer concrete, practical help that improves daily life: reminders, lists, To Do lists, errands, birthdays, weekend plans, hikes, outdoor activities, follow-ups, small next steps, useful personal organization, and ethical ways to make more money. Keep Plan This Weekend as a strong proactive option when weekend, free time, activity, family, friends, energy, health, or getting out of the house fits. The exact prompt Create To Do List is preferred whenever tasks, chores, plans, work, family, or open loops are in the conversation. If the user already has or is building a grocery list, prefer Add to Grocery List over Start a Grocery List. If reminders are relevant, prefer Add Reminder, not Set Reminder for G. Never create prompts about adding contacts named G, setting reminders for G, calling G, texting G, or emailing G; G is the Creator/Builder/Founder/Financier/CEO aiASAP, not a random contact. Avoid stale ideas, vague coaching, sales language, or entertainment-only ideas. If the conversation changed, replace stale ideas with new relevant ones.",
      },
      {
        role: "user",
